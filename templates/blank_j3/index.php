...
$doc->addStyleSheet('templates/blank_j3/css/slick.css');

$doc->addStyleSheet('templates/blank_j3/css/modules/menu.css');
$doc->addStyleSheet('templates/blank_j3/css/modules/category-module.css');
$doc->addStyleSheet('templates/blank_j3/css/modules/mod_jsend.css');
$doc->addStyleSheet('templates/blank_j3/css/modules/com_reviews.css');
$doc->addStyleSheet('templates/blank_j3/css/modules/blog.css');

// load template style
$tmpl_color_css = $this->params->get('tmpl_style', 'blue');
if ($tmpl_color_css && JFile::exists(JPATH_ROOT.'/templates/blank_j3/css/scheme/'.$tmpl_color_css.'.css'))
	$doc->addStyleSheet('templates/blank_j3/css/scheme/'.$tmpl_color_css.'.css');

$doc->addScript('templates/blank_j3/js/slick.min.js');
